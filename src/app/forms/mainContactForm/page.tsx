...
const MainContactForm = () => {
  ...
  return (
    <div>
      ...
      >
        <h1 className="text-green-500 text-4xl font-serif text-center mb-10">
          עוד כמה פרטים בבקשה שנוכל לבנון את החופשה שתתאים במיוחד עבורכם
        </h1>
        <div className="flex flex-col gap-6">
          ...
          /> */}
            ...
            <Button
              variant={"default"}
              className="text-white font-bold bg-green-500 hover:bg-green-700"
            >
              שלח
            </Button>
          </div>
